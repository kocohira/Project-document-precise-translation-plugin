...
Excel = load_workbook(r'C:\Users\kocohira\Desktop\Special\名古屋蓝体字二期—Jack_Source.xlsx')  ###读取Excel比较表格

Sheet = Excel['名古屋']  ###打开‘大阪’工作表
...
while Count_Row < Max_Row + 1 :
    ...
    price = int(Sheet.cell(row=Count_Row, column=3).value)
    ...
    if price >= 150 :
        ...
        Sheet.cell(row=Count_Row, column=3).value = 9.9

        print(Count_Row)

        Excel.save(r'C:\Users\kocohira\Desktop\Special\名古屋蓝体字二期—Jack_Source.xlsx')
...
while Count_Row < Max_Row + 1 :
    ...
    Authorization = int(Sheet.cell(row=Count_Row, column=3).value)
